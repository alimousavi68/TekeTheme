 ...
 */
 ...
 class Blogistic_Tags_Collection_Widget extends WP_Widget {
    public function __construct() {
        parent::__construct(
            'blogistic_tags_collection_widget',
            esc_html__( 'Blogistic: Tags Collection', 'blogistic' ),
            [ 'description' => __( 'A collection of post tags', 'blogistic' ) ]
        );
    }
    ...
    public function widget_fields() {
        ...
        return [
            [
                ...
                'default'   =>  esc_html__( 'Tags Collection', 'blogistic' )
            ],
            [
                'name'  =>  'post_tags',
                'type'  =>  'select-two',
                'title' =>  esc_html__( 'Post tags', 'blogistic' ),
                'description'   =>  esc_html__( 'Choose the tags to display', 'blogistic' ),
