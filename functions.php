...
function remove_default_fonts() {
    // فرض بر این است که 'enqueue_fonts' نام تابعی است که فونت‌ها را بارگذاری می‌کند.
    // شما باید نام دقیق تابع یا اکشنی که فونت‌ها را بارگذاری می‌کند را پیدا کنید و جایگزین کنید.
    remove_action('wp_enqueue_scripts', 'enqueue_fonts');
}

add_action('init', 'remove_default_fonts');
